...
if($msg == 'deleted'){
    ...
    $kode = @$_GET['pilihbrg'] ? $_GET['pilihbrg'] : null;
                    ...
                    <div class="col-lg-6">
                        <div class="card card-outline card-warning p-3">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-10">
                                    <select name="kodeBrg" class="form-control" id="kodeBrg">
                        ...
                        <tbody>
                            ...
                            foreach ($brgDetail as $detail) { ?>
                                <tr>
                                    ...
                                    <td class="text-center"><a href="?idbrg=<?= $detail['kode_brg']?>&idbeli=<?= $detail['no_beli']?>&qty=<?= $detail['qty']?>&tgl=<?= $detail['tgl_beli']?>&msg=deleted" class="btn btn-sm btn-danger" title="hapus naramg" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?')"><i class="fas fa-trash"></i></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
