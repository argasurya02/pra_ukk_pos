...
<head>
  ...
  <script src="<?= $main_url ?>asset/adminLTE-3.2.0/plugins/toastr/toastr.min.js"></script>
  <link rel="stylesheet" href="<?= $main_url ?>asset/adminLTE-3.2.0/plugins/toastr/toastr.min.css"> 
</head>
<!--
`body` tag options:
