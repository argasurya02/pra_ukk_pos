...
$title = "Change Password | Arga Store";
...
if (isset($_POST['simpan'])) {
    if (updatePelanggan($_POST)) {
        echo "<script>
                    alert('Password berhasil di perbarui');
                    document.location='change-password-pelanggan.php';
                </script>";
    }
}
...
if (isset($_GET['msg'])) {
    ...
    $alert2 = '<small class="text-danger pl-2 font-italic">Current password tidak sesuai</small>';
?>
            ...
            <div class="card">
                <form action="" method="post">
                    <div class="card-header">
                        ...
                        <button type="submit" name="simpan" class="btn btn-primary float-right btn-sm"><i class="fas fa-edit"></i> Submit</button>
                        <button type="reset" name="reset" class="btn btn-danger btn-sm float-right mr-1"><i class="fas fa-times"></i> Reset</button>
                    </div>
                    <div class="card-body">
                        <div class="col-lg-8 mb-3">
                            <div class="form-group">
                                <label for="curPass">Current Passsword</label>
